<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Search Results (Vulnerable Implementation)
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-4" role="alert">
                        ...
                        <p>This search feature is vulnerable to IDOR as it can return notes from other users!</p>
                        ...
                        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            @foreach($notes as $note)
                                <div class="border rounded-lg p-4 shadow-sm">
                                    ...
                                    <p class="text-gray-600 mb-1 text-visible">{{ Str::limit($note->content, 100) }}</p>
                                    <p class="text-sm text-red-500 mb-3">User ID: {{ $note->user_id }}</p>
