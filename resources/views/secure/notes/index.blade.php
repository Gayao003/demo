                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex space-x-2">
                            <form action="{{ route('secure.notes.search') }}" method="GET" class="flex">
                            ...
                            <a href="{{ route('secure.notes.create') }}" class="bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 rounded btn-black-text">
                                Create New Note
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-4" role="alert">
                        ...
                        <p class="mt-2">Additional security measures:</p>
                        <ul class="list-disc ml-5">
                            <li>Search is limited to your own notes only</li>
                            <li>Input validation and sanitization is performed</li>
                        </ul>
                    </div>
